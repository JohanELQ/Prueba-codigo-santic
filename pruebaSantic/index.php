...
<!-- Codigo php para conectar con la base de datos -->
<?php
...
$sel = $con->query("SELECT * FROM documentos");
    ...
    <body>
                            ...
                            <?php foreach ($res as $val) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/pruebaSantic/' . $val['url']; ?>" >Ver Archivo pagina</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
        ...
        <script>
                            ...
                            function openModelPDF(url) {
                                $('#modalPdf').modal('show');
                                $('#iframePDF').attr('src','<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/pruebaSantic/'; ?>'+url);
                            }
        </script>
